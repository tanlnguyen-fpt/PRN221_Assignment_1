...

    {
        ...
        private void SetHeader()
        {
            ...
            switch (ManagementType)
            {
                ...
                case "PRODUCT":
                    dg.Columns[0].Header = "ID";
                    dg.Columns[1].Header = "Category ID";
                    dg.Columns[2].Header = "Product Name";
                    dg.Columns[3].Header = "Weight";
                    dg.Columns[4].Header = "Unit Price";
                    dg.Columns[5].Header = "Unit In Stock";
